...
<div class="contact">
    ...
    <form class:sending method="POST" use:enhance={() => {
        ...
        <span class="header">
            ...
            <span class="text">
                <span class="strikethrough">Or the highway</span> Or my way
            </span>
        </span>
        <div class="inputs">
            <div class="form-group">
                <input required type="text" name="name" placeholder="NAME" />
                <input required type="text" name="company" placeholder="ORGANIZATION" />
            </div>
            <div class="form-group">
